 ...
 *
 * Load động bởi AuctionDetailController.loadComments().
 * Mỗi comment trong commentsPane là một instance riêng biệt.
 *
...
public class CommentController {
    ...
    @FXML private Label name;    // tên người đăng
    @FXML private Label message; // nội dung comment
    @FXML private Label time;    // thời gian (vd: "Just now", "2 hours ago")

    /**
     * Điền dữ liệu vào comment card.
     * Được gọi bởi AuctionDetailController sau khi load FXML.
     *
