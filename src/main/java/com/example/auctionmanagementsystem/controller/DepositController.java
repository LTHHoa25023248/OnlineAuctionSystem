 ...
 *
 * Tính năng: - Hiển thị số dư hiện tại - Chọn nhanh số tiền qua 8 preset buttons (10, 50, 100, 500,
 * 1000, 2000, 5000, 10000) - Nhập số tiền thủ công - Validate và cộng vào số dư
 *
 * Lưu ý: Button text trong FXML là số thuần (10, 50, 100...) không có "$" hay "," để tránh lỗi FXML
 * parser (dấu $ được parser hiểu là binding expression).
 *
...
public class DepositController {
  ...
  // ── FXML fields ───────────────────────────────────────────────────────────
  @FXML
  private Label balanceLabel; // hiển thị số dư hiện tại
  @FXML
  private MFXTextField amountField; // input số tiền thủ công
  @FXML
  private Label validationLabel;// thông báo lỗi hoặc thành công
  @FXML
  private MFXButton depositButton; // nút "Deposit Now"
  @FXML
  private MFXButton closeButton; // nút đóng popup

  // 8 preset buttons — text là số thuần không có ký tự đặc biệt
  @FXML
  private MFXButton btn10;
  @FXML
  private MFXButton btn50;
  @FXML
  private MFXButton btn100;
  @FXML
  private MFXButton btn500;
  @FXML
  private MFXButton btn1000;
  @FXML
  private MFXButton btn2000;
  @FXML
  private MFXButton btn5000;
  @FXML
  private MFXButton btn10000;
  ...
  /**
   * Xử lý click preset button (10, 50, 100...). Lấy text của button (số thuần) và điền vào
   * amountField. Dùng ActionEvent thay MouseEvent vì FXML dùng onAction.
   *
  ...
  /**
   * Xử lý nạp tiền khi bấm "Deposit Now". Validate amount rồi cộng vào currentBalance.
   *
   * Quy tắc validate: - Không được để trống - Phải là số dương - Tối thiểu 10 USD - Tối đa 100,000
   * USD
   */
  @FXML
  ...
  /**
   * Format số tiền với dấu phẩy ngăn cách hàng nghìn và 2 chữ số thập phân. Ví dụ: 1500.5 →
   * "1,500.50"
   */
  ...
  /**
   * Đóng popup Deposit. closeButton là MFXButton với onAction="#handleClose" trong FXML.
   */
  @FXML
